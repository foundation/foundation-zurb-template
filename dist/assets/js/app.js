...
*/
(0, _jquery2.default)('a[data-reveal-return]').on('click', function () {
  var $a = (0, _jquery2.default)(this);
  var returnModalID = $a.data('reveal-return');
  var $returnModal = (0, _jquery2.default)('#' + returnModalID);
  var $nextModal = (0, _jquery2.default)($a.attr('href'));
...
var modalOpen = false;
var $reveal = (0, _jquery2.default)('.reveal');
...
$window.one('scroll', function () {
  var $primaryNav = (0, _jquery2.default)('.nav-primary');
  $primaryNav.addClass('visible');
});

// Parallax background effect
var $parallaxSection = (0, _jquery2.default)('[data-parallax-bg]');
$window.on('scroll', function () {
  $parallaxSection.each(function () {
    ...
    if (thisOffset.top < document.documentElement.clientHeight && thisOffset.bottom > 0) {
      // If in view
      var $background = (0, _jquery2.default)(this).find('.background');
...
_foundation.Foundation.Motion = _foundationUtil2.Motion;
_foundation.Foundation.Move = _foundationUtil2.Move;
...
_foundation.Foundation.plugin(_foundation3.Reveal, 'Reveal');
